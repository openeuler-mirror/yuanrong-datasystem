...
public:
    systemd_sink(std::string ident = "", bool enable_formatting = false)
        ...
        , syslog_levels_{{/* ds_spdlog::level::trace      */ LOG_DEBUG,
              /* ds_spdlog::level::debug      */ LOG_DEBUG,
              /* ds_spdlog::level::info       */ LOG_INFO,
              /* ds_spdlog::level::warn       */ LOG_WARNING,
              /* ds_spdlog::level::err        */ LOG_ERR,
              /* ds_spdlog::level::critical   */ LOG_CRIT,
              /* ds_spdlog::level::off        */ LOG_INFO}}
    {}
