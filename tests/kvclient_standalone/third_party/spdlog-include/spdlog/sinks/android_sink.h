...
private:
    ...
    static android_LogPriority convert_to_android_(ds_spdlog::level::level_enum level)
    {
        switch (level)
        {
        case ds_spdlog::level::trace:
            return ANDROID_LOG_VERBOSE;
        case ds_spdlog::level::debug:
            return ANDROID_LOG_DEBUG;
        case ds_spdlog::level::info:
            return ANDROID_LOG_INFO;
        case ds_spdlog::level::warn:
            return ANDROID_LOG_WARN;
        case ds_spdlog::level::err:
            return ANDROID_LOG_ERROR;
        case ds_spdlog::level::critical:
