 ...
 * Usages:
 *    auto sink =  std::make_shared<ds_spdlog::sinks::daily_file_format_sink_mt>("myapp-%Y-%m-%d:%H:%M:%S.log", hour, minute);"
 *    auto logger = ds_spdlog::daily_logger_format_mt("loggername, "myapp-%Y-%m-%d:%X.log", hour,  minute)"
 *
 */
...
private:
    ...
    tm now_tm(log_clock::time_point tp)
    {
        ...
        return ds_spdlog::details::os::localtime(tnow);
    }
