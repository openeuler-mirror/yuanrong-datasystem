    ...
    WithPublisherAndSubscriber(
        ...
        [](const std::shared_ptr<KvEventPublisher> &publisher) {
            ...
            auto evictionManager =
                std::make_shared<WorkerOcEvictionManager>(objectTable, localAddress, localAddress);
...
TEST_F(KvEventPublisherTest, MultiPublishUpdatePublishesStoredCpuEventForEachKey)
{
    ...
    WithPublisherAndSubscriber(
        ...
        [](const std::shared_ptr<KvEventPublisher> &publisher) {
            ...
            WorkerOcServiceMultiPublishImpl multiPublish(param, nullptr, memCpyThreadPool, notifyThreadPool,
                                                         akSkManager, localAddress);
