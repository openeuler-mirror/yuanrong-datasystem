...
if ("$ENV{DS_PACKAGE}" STREQUAL "")
    if (NOT "$ENV{DS_LOCAL_LIBS_DIR}" STREQUAL "")
        ...
        set(braft_URL "https://gitee.com/mirrors/braft/repository/archive/v1.1.2.zip")
    endif()
    set(braft_SHA256 "6541e627e9b6234edcfbde4daa0e2849f81a461e5f396a2b9df781ae2ee80375")
else()
