...
openYuanrong 分为三个代码仓库：[yuanrong-runtime](https://gitcode.com/openeuler/yuanrong) 对应多语言函数运行时；[yuanrong-functionsystem](https://gitcode.com/openeuler/yuanrong-functionsystem) 对应函数系统；[yuanrong-datasystem](https://gitcode.com/openeuler/yuanrong-datasystem) 对应数据系统，即当前代码仓。
