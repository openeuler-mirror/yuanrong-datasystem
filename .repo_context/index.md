...
| understand the dscli cluster member cleanup command design for removing stale topology records by worker address | `docs/source_zh_cn/design_document/dscli_cluster_member_cleanup_detailed.md` | `cli/query.py`, `src/datasystem/client/cluster_query/cluster_query_client.cpp`, `src/datasystem/worker/worker_cli.cpp`, `src/datasystem/cluster/repository/topology_key_helper.cpp` |
...
| design unified class-based random log sampling | `modules/infra/logging/log-sampler-design.md` | `src/datasystem/common/log/*`, `src/datasystem/common/log/spdlog/*`, `src/datasystem/common/metrics/hard_disk_exporter/*`, `src/datasystem/common/flags/*` |
| design request-stage access-log latency summaries | `modules/infra/logging/request-stage-latency-trace-plan.md` | `src/datasystem/common/log/*`, `src/datasystem/client/object_cache/*`, `src/datasystem/client/kv_cache/*`, `src/datasystem/worker/object_cache/*`, `src/datasystem/master/object_cache/*`, `src/datasystem/protos/*` |
| design `SLOW_LOG` request logs that bypass request sampling | `modules/infra/logging/slow-log-request-plan.md` | `src/datasystem/common/log/*`, `src/datasystem/worker/object_cache/*`, `src/datasystem/master/object_cache/*`, `src/datasystem/common/rdma/*`, `src/datasystem/common/rpc/zmq/*` |
...
| l2 cache backend selection | `modules/infra/l2cache/l2-cache-type.md` | `src/datasystem/common/l2cache/*`, `src/datasystem/common/flags/*` |
...
| request-stage latency trace access-log plan | `modules/infra/logging/request-stage-latency-trace-plan.md` | `src/datasystem/common/log/*`, `src/datasystem/client/object_cache/*`, `src/datasystem/client/kv_cache/*`, `src/datasystem/worker/object_cache/*`, `src/datasystem/master/object_cache/*`, `src/datasystem/protos/*` |
| `SLOW_LOG` request design | `modules/infra/logging/slow-log-request-plan.md` | `src/datasystem/common/log/*`, `src/datasystem/worker/object_cache/*`, `src/datasystem/master/object_cache/*`, `src/datasystem/common/rdma/*`, `src/datasystem/common/rpc/zmq/*` |
