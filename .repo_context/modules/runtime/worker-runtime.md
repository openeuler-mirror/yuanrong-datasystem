...
- Run focused fault-worker convergence coverage:
  - `bazel test //tests/ut/worker:worker_oc_server_test //tests/ut/master/object_cache:oc_notify_worker_manager_test`
