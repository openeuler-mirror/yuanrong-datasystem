...
- Verified:
  ...
  - process jemalloc bvars live in `src/datasystem/common/memory/jemalloc_stats_bvar.*`; they are a BRPC `/vars`
    pull path and do not participate in `common_metrics`, resource-monitor logs, or JSON-lines exporters.
