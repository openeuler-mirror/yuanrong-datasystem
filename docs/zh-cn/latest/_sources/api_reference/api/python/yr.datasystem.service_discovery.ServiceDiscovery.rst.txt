...
.. py:class:: yr.datasystem.service_discovery.ServiceDiscovery(options)

    通过 ETCD 获取可用 Worker。

    参数：
        - **options** (:doc:`ServiceDiscoveryOptions <yr.datasystem.service_discovery.ServiceDiscoveryOptions>`) - 服务发现配置。
    ...
    **方法**：
    ...
    .. code-block:: python
        ...
        service_discovery = ServiceDiscovery(options)
