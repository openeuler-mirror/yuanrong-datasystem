...
public:
    ...
    {
        // Retry replica-not-ready plus transient RPC errors. brpc network blips
        // match the legacy K_RPC_UNAVAILABLE retry policy in RetryOnError();
        // K_RPC_PEER_DEAD intentionally fails fast and is not retried here.
        return RetryOnError(
