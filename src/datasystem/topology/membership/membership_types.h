 ...
 */
#ifndef DATASYSTEM_COMMON_TOPOLOGY_MEMBERSHIP_MEMBERSHIP_TYPES_H
#define DATASYSTEM_COMMON_TOPOLOGY_MEMBERSHIP_MEMBERSHIP_TYPES_H
...
#endif  // DATASYSTEM_COMMON_TOPOLOGY_MEMBERSHIP_MEMBERSHIP_TYPES_H
