...
/**
 * Description: Topology coordination backend abstraction.
 */
#ifndef DATASYSTEM_TOPOLOGY_COORDINATION_BACKEND_I_COORDINATION_BACKEND_H
#define DATASYSTEM_TOPOLOGY_COORDINATION_BACKEND_I_COORDINATION_BACKEND_H
...
#endif  // DATASYSTEM_TOPOLOGY_COORDINATION_BACKEND_I_COORDINATION_BACKEND_H
