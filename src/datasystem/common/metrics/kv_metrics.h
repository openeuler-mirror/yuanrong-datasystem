...
enum class KvMetricId : uint16_t {
    ...
    COORDINATOR_RPC_PUT_REQUEST_TOTAL,
    COORDINATOR_RPC_RANGE_REQUEST_TOTAL,
    COORDINATOR_RPC_DELETE_RANGE_REQUEST_TOTAL,
    COORDINATOR_RPC_WATCH_RANGE_REQUEST_TOTAL,
    COORDINATOR_RPC_CANCEL_WATCH_REQUEST_TOTAL,
    COORDINATOR_RPC_KEEP_ALIVE_REQUEST_TOTAL,
    COORDINATOR_RPC_GET_COORDINATOR_ID_REQUEST_TOTAL,
    COORDINATOR_RPC_REPORT_TOPOLOGY_RECOVERY_CANDIDATE_REQUEST_TOTAL,
    COORDINATOR_RPC_GET_CLUSTER_RAW_SNAPSHOT_REQUEST_TOTAL,
    COORDINATOR_RPC_GET_RAFT_BOOTSTRAP_STATE_REQUEST_TOTAL,
    COORDINATOR_RPC_ENSURE_LEADER_MEMBERSHIP_REQUEST_TOTAL,
    COORDINATOR_RPC_REPORT_WORKER_LIVENESS_REQUEST_TOTAL,
    // Successfully delivered watch-notification RPC batches and the events carried by them.
    COORDINATOR_WATCH_NOTIFICATION_SENT_BATCHES_TOTAL,
    COORDINATOR_WATCH_NOTIFICATION_SENT_EVENTS_TOTAL,
    // Serialized EventReqPb bytes in successfully delivered business notifications; excludes transport framing.
    COORDINATOR_WATCH_NOTIFICATION_SENT_BYTES_TOTAL,
    COORDINATOR_WATCH_RPC_LATENCY,
    COORDINATOR_WATCH_RPC_FAILURE_TOTAL,
    COORDINATOR_WATCH_CHANNELS,
    COORDINATOR_WATCH_FAN_OUT_EVENTS_TOTAL,
    COORDINATOR_WATCH_NOTIFICATION_INFLIGHT_REQUESTS,
    COORDINATOR_WATCH_NOTIFICATION_INFLIGHT_BYTES,
    COORDINATOR_WATCH_PROBE_INFLIGHT_REQUESTS,
    COORDINATOR_WATCH_PROBE_INFLIGHT_BYTES,
    KV_METRIC_END
};
