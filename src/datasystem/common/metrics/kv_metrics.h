...
enum class KvMetricId : uint16_t {
    ...
    WORKER_MODE_TRANSITION_LATENCY,
    WORKER_ADMISSION_REJECT_LATENCY,
    WORKER_ADMISSION_REJECT_STARTING_TOTAL,
    WORKER_ADMISSION_REJECT_JOINING_TOTAL,
    WORKER_ADMISSION_REJECT_RUNNING_TOTAL,
    WORKER_ADMISSION_REJECT_DRAINING_TOTAL,
    WORKER_ADMISSION_REJECT_LOCAL_ISOLATED_TOTAL,
    WORKER_ADMISSION_REJECT_OUT_OF_MEMORY_TOTAL,
    WORKER_ADMISSION_REJECT_RECOVERING_TOTAL,
    WORKER_ADMISSION_REJECT_STOPPING_TOTAL,
    WORKER_OBJECT_TABLE_LOCK_HOLD_LATENCY,
    WORKER_RECOVERY_CANDIDATE_COUNT,
    WORKER_METADATA_RECOVERY_BATCH_LATENCY,
    WORKER_CLEANUP_BATCH_LATENCY,
