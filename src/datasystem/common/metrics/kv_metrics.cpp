...
constexpr MetricDesc KV_METRIC_DESCS[] = {
    ...
    { 110, "worker_service_mode", MetricType::GAUGE, "" },
    { 111, "worker_service_reason", MetricType::GAUGE, "" },
    { 112, "worker_recovery_phase", MetricType::GAUGE, "" },
    { 113, "worker_mode_transition_latency", MetricType::HISTOGRAM, "us" },
    { 114, "worker_admission_reject_latency", MetricType::HISTOGRAM, "us" },
    { 115, "worker_admission_reject_starting_total", MetricType::COUNTER, "count" },
    { 116, "worker_admission_reject_joining_total", MetricType::COUNTER, "count" },
    { 117, "worker_admission_reject_running_total", MetricType::COUNTER, "count" },
    { 118, "worker_admission_reject_draining_total", MetricType::COUNTER, "count" },
    { 119, "worker_admission_reject_local_isolated_total", MetricType::COUNTER, "count" },
    { 120, "worker_admission_reject_out_of_memory_total", MetricType::COUNTER, "count" },
    { 121, "worker_admission_reject_recovering_total", MetricType::COUNTER, "count" },
    { 122, "worker_admission_reject_stopping_total", MetricType::COUNTER, "count" },
    { 123, "worker_object_table_lock_hold_latency", MetricType::HISTOGRAM, "us" },
    { 124, "worker_recovery_candidate_count", MetricType::HISTOGRAM, "count" },
    { 125, "worker_metadata_recovery_batch_latency", MetricType::HISTOGRAM, "us" },
    { 126, "worker_cleanup_batch_latency", MetricType::HISTOGRAM, "us" },
    { 127, "worker_recovery_evidence_mask", MetricType::GAUGE, "" },
};
