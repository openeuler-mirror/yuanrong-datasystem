...
constexpr MetricDesc KV_METRIC_DESCS[] = {
    ...
    { 113, "worker_recovery_evidence_mask", MetricType::GAUGE, "" },
    { 114, "worker_admission_reject_total", MetricType::COUNTER, "count" },
    { 115, "worker_control_backend_scope_local_total", MetricType::COUNTER, "count" },
    { 116, "worker_control_backend_scope_global_total", MetricType::COUNTER, "count" },
    { 117, "worker_control_backend_scope_inconclusive_total", MetricType::COUNTER, "count" },
};
