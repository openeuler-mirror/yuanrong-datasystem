...
constexpr MetricDesc KV_METRIC_DESCS[] = {
    ...
    { 37, "worker_allocator_alloc_bytes_total", MetricType::COUNTER, "bytes" },
    { 38, "worker_allocator_free_bytes_total", MetricType::COUNTER, "bytes" },
    { 39, "worker_shm_unit_created_total", MetricType::COUNTER, "count" },
    { 40, "worker_shm_unit_destroyed_total", MetricType::COUNTER, "count" },
    { 41, "worker_shm_ref_add_total", MetricType::COUNTER, "count" },
    { 42, "worker_shm_ref_remove_total", MetricType::COUNTER, "count" },
    { 43, "worker_shm_ref_table_size", MetricType::GAUGE, "count" },
    { 44, "worker_shm_ref_table_bytes", MetricType::GAUGE, "bytes" },
    { 45, "worker_remove_client_refs_total", MetricType::COUNTER, "count" },
    { 46, "worker_object_erase_total", MetricType::COUNTER, "count" },
    { 47, "master_object_meta_table_size", MetricType::GAUGE, "count" },
    // Depth of TTL time queue (timedObj_); not a separate count of failedObjects_ retry metadata alone.
    { 48, "master_ttl_pending_size", MetricType::GAUGE, "count" },
    { 49, "master_ttl_fire_total", MetricType::COUNTER, "count" },
    { 50, "master_ttl_delete_success_total", MetricType::COUNTER, "count" },
    { 51, "master_ttl_delete_failed_total", MetricType::COUNTER, "count" },
    { 52, "master_ttl_retry_total", MetricType::COUNTER, "count" },
