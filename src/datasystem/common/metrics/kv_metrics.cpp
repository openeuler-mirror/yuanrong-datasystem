...
constexpr MetricDesc KV_METRIC_DESCS[] = {
    ...
    { 38, "zmq_client_queuing_latency", MetricType::HISTOGRAM, "us" },
    { 39, "zmq_server_queue_wait_latency", MetricType::HISTOGRAM, "us" },
    { 40, "zmq_server_exec_latency", MetricType::HISTOGRAM, "us" },
    { 41, "zmq_server_reply_latency", MetricType::HISTOGRAM, "us" },
