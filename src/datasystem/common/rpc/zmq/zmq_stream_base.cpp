...
StreamBase::StreamBase(bool sendPayload, bool recvPayload) : sendPayload_(sendPayload), recvPayload_(recvPayload)
{
}

bool StreamBase::HasSendPayloadOp() const
{
    return sendPayload_;
}

bool StreamBase::HasRecvPayloadOp() const
{
    return recvPayload_;
}
}  // namespace datasystem
