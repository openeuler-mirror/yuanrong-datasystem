...
#ifdef WITH_TESTS
static constexpr int STUB_FRONTEND_TIMEOUT = 3000;     // Timeout for UnixSockFd::InitFrontend in test.
#else
static constexpr int STUB_FRONTEND_TIMEOUT = 3000;     // Timeout for UnixSockFd::InitFrontend.
#endif
