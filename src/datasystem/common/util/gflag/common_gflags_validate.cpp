...
DS_DEFINE_validator(eviction_high_watermark_percent, &Validator::ValidateEvictionHighWatermarkPercent);
DS_DEFINE_validator(eviction_low_watermark_percent, &Validator::ValidateEvictionLowWatermarkPercent);
DS_DEFINE_validator(spill_high_watermark_percent, &Validator::ValidateSpillHighWatermarkPercent);
DS_DEFINE_validator(spill_low_watermark_percent, &Validator::ValidateSpillLowWatermarkPercent);
