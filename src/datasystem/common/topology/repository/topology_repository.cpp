...
Status ReadRing(IClusterStore &store, RangeSearchResult &res)
{
...
TopologyRepository::TopologyRepository(IClusterStore &store) : store_(store)
{
}
...
Status TopologyRepository::HandleCommittedTopologyEvent(const ClusterStoreEvent &event, TopologyWatchEvent &typed)
{
    typed = {};
