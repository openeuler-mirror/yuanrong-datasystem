...
public:
    ...
    /**
     * @brief Apply one cluster-store event that was delivered by the shared IClusterStore event dispatcher.
     ...
     */
    Status HandleStoreEvent(const ClusterStoreEvent &event);
