...
{   
    ...
    std::string getKeyFilesPath;
    std::string getValueFilesPath;
    // 轮询
    while (true) {
        RETURN_IF_NOT_OK_PRINT_ERROR_MSG(master_->dequeue(getKeyFilesPath, getValueFilesPath), "download file failed");
