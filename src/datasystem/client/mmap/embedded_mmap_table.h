 ...
 */
#ifndef DATASYSTEM_CLIENT_MMAP_EMBEDDED__MMAP_TABLE_H
#define DATASYSTEM_CLIENT_MMAP_EMBEDDED__MMAP_TABLE_H
...
namespace client {
class EmbeddedMmapTable : public IMmapTable {
public:
    EmbeddedMmapTable() = delete;

    ~EmbeddedMmapTable() = default;

    EmbeddedMmapTable(bool enableHugeTlb) : IMmapTable(enableHugeTlb) {};
    /**
